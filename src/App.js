...
const App = () => {
  ...
  const [message, setMessage] = useState(
    "Kindly provide your credit card details"
  );
  ...
  const handleChange = (e) => {
    ...
    if (name === "cvv" || name === "number") {
      // regex that only accepts number as input/value
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setMessage("Thank you for your services");
  };
    ...
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="supporting-inputs-container">
          <label>
            Expiry date
            <input type="month" required onChange={handleChange} />
          </label>
